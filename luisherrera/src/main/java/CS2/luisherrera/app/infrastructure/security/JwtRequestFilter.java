...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    @Autowired
    private JwtTokenUtil jwtTokenUtil; // ✅ Corregido
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            ...
            try {
                username = jwtTokenUtil.extractUsername(jwt); // ✅ Corregido
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (user.isPresent() && jwtTokenUtil.validateToken(jwt, username)) { // ✅ Corregido
                UsernamePasswordAuthenticationToken authToken =
                        new UsernamePasswordAuthenticationToken(
                                new User(username, user.get().getPassword(), Collections.emptyList()),
                                null,
